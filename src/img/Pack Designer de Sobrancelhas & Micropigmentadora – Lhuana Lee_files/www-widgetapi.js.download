...
na.compatMode?na.documentElement:na.body;var ba=(new Ed(Y.clientWidth,Y.clientHeight)).round()}catch(X){ba=new Ed(-12245933,-12245933)}na=ba;ba={};var ca=void 0===ca?A:ca;Y=new Me;ca.SVGElement&&ca.document.createElementNS&&Y.set(0);y=Ld();y["allow-top-navigation-by-user-activation"]&&Y.set(1);y["allow-popups-to-escape-sandbox"]&&Y.set(2);ca.crypto&&ca.crypto.subtle&&Y.set(3);ca.TextDecoder&&ca.TextEncoder&&Y.set(4);ca=Ne(Y);ba.bc=ca;ba.bih=na.height;ba.biw=na.width;ba.brdim=p.join();b=b.j;b=(ba.vis=
...
function Qk(a){function b(){var f,g,h,k,l,m,q,t,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",xa(z,2),w(z,a.l(a.name,a.options.version,d),4);case 4:h=z.j;for(var G=a.options,K=[],M=u(Object.keys(G.ka)),P=M.next();!P.done;P=M.next()){P=P.value;var kb=G.ka[P],uc=void 0===kb.wb?Number.MAX_VALUE:kb.wb;!(h.i.version>=kb.Ba)||h.i.version>=uc||h.i.objectStoreNames.contains(P)||K.push(P)}k=K;if(0===k.length){z.s(5);break}l=Object.keys(a.options.ka);m=h.objectStoreNames();
...
if(K.startsWith(G+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var P=y.lineNumber||"Not available",kb=y.fileName||"Not available",uc=K,va=0;if(t.hasOwnProperty("args")&&t.args&&t.args.length)for(var na=0;na<t.args.length&&!(va=yn(t.args[na],"params."+na,p,va),500<=va);na++);else if(t.hasOwnProperty("params")&&t.params){var Y=t.params;if("object"===typeof t.params)for(q in Y){if(Y[q]){var ba="params."+q,ca=An(Y[q]);p[ba]=ca;va+=ba.length+ca.length;if(500<va)break}}else p.params=An(Y)}if(Hn.length)for(var X=
0;X<Hn.length&&!(va=yn(Hn[X],"params.context."+X,p,va),500<=va);X++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:P,fileName:kb,stack:uc,params:p,sampleWeight:1},Oj=Number(t.columnNumber);isNaN(Oj)||(S.lineNumber=S.lineNumber+":"+Oj);if("IGNORED"===t.level)m=0;else a:{for(var Pj=un(),Qj=u(Pj.Y),Qf=Qj.next();!Qf.done;Qf=Qj.next()){var Rj=Qf.value;if(S.message&&S.message.match(Rj.Ub)){m=Rj.weight;break a}}for(var Sj=u(Pj.W),
Rf=Sj.next();!Rf.done;Rf=Sj.next()){var Tj=Rf.value;if(Tj.lb(S)){m=Tj.weight;break a}}m=1}S.sampleWeight=m;for(var Uj=u(pn),Sf=Uj.next();!Sf.done;Sf=Uj.next()){var Tf=Sf.value;if(Tf.xa[S.name])for(var Vj=u(Tf.xa[S.name]),Uf=Vj.next();!Uf.done;Uf=Vj.next()){var Wj=Uf.value,Md=S.message.match(Wj.regexp);if(Md){S.params["params.error.original"]=Md[0];for(var Vf=Wj.groups,Xj={},Vb=0;Vb<Vf.length;Vb++)Xj[Vf[Vb]]=Md[Vb+1],S.params["params.error."+Vf[Vb]]=Md[Vb+1];S.message=Tf.Ga(Xj);break}}}S.params||(S.params=
...
h&&vn.fa("handleWarning",ra);if(O("kevlar_gel_error_routing"))a:{var Xf=void 0,Yf=void 0,Hc=h,R=ra;if(O("errors_via_jspb")){if(Jn())Yf=void 0;else{var Wb=new fh;F(Wb,1,R.stack);R.fileName&&F(Wb,4,R.fileName);var Ja=R.lineNumber&&R.lineNumber.split?R.lineNumber.split(":"):[];0!==Ja.length&&(1!==Ja.length||isNaN(Number(Ja[0]))?2!==Ja.length||isNaN(Number(Ja[0]))||isNaN(Number(Ja[1]))||(F(Wb,2,Number(Ja[0])),F(Wb,3,Number(Ja[1]))):F(Wb,2,Number(Ja[0])));var pb=new ih;F(pb,1,R.message);F(pb,3,R.name);
F(pb,6,R.sampleWeight);"ERROR"===Hc?F(pb,2,2):"WARNING"===Hc?F(pb,2,1):F(pb,2,0);var Zf=new gh;F(Zf,1,!0);kd(Zf,fh,3,hh,Wb);var qb=new ch;F(qb,3,window.location.href);for(var fk=N("FEXP_EXPERIMENTS",[]),$f=0;$f<fk.length;$f++){var gk=qb,lo=fk[$f];Rc(gk);fd(gk,5).push(lo)}var ag=Ch();if(!Dh()&&ag)for(var hk=u(Object.keys(ag)),rb=hk.next();!rb.done;rb=hk.next()){var ik=rb.value,bg=new eh;F(bg,1,ik);bg.setValue(String(ag[ik]));md(qb,4,eh,bg)}var cg=R.params;if(cg){var jk=u(Object.keys(cg));for(rb=jk.next();!rb.done;rb=
jk.next()){var kk=rb.value,dg=new eh;F(dg,1,"client."+kk);dg.setValue(String(cg[kk]));md(qb,4,eh,dg)}}var lk=N("SERVER_NAME"),mk=N("SERVER_VERSION");if(lk&&mk){var eg=new eh;F(eg,1,"server.name");eg.setValue(lk);md(qb,4,eh,eg);var fg=new eh;F(fg,1,"server.version");fg.setValue(mk);md(qb,4,eh,fg)}var Nd=new jh;H(Nd,ch,1,qb);H(Nd,gh,2,Zf);H(Nd,ih,3,pb);Yf=Nd}var nk=Yf;if(!nk)break a;var ok=new qh;kd(ok,jh,163,rh,nk);Cn(ok)}else{if(Jn())Xf=void 0;else{var Ic={stackTrace:R.stack};R.fileName&&(Ic.filename=
...
Xb={pageUrl:window.location.href,kvPairs:[]};N("FEXP_EXPERIMENTS")&&(Xb.experimentIds=N("FEXP_EXPERIMENTS"));var hg=Ch();if(!Dh()&&hg)for(var pk=u(Object.keys(hg)),sb=pk.next();!sb.done;sb=pk.next()){var qk=sb.value;Xb.kvPairs.push({key:qk,value:String(hg[qk])})}var ig=R.params;if(ig){var rk=u(Object.keys(ig));for(sb=rk.next();!sb.done;sb=rk.next()){var sk=sb.value;Xb.kvPairs.push({key:"client."+sk,value:String(ig[sk])})}}var tk=N("SERVER_NAME"),uk=N("SERVER_VERSION");tk&&uk&&(Xb.kvPairs.push({key:"server.name",
value:tk}),Xb.kvPairs.push({key:"server.version",value:uk}));Xf={errorMetadata:Xb,stackTrace:mo,logMessage:gg}}var vk=Xf;if(!vk)break a;on("clientError",vk)}if("ERROR"===Hc||O("errors_flush_gel_always_killswitch"))b:{if(O("web_fp_via_jspb")&&(mn(!0),!O("web_fp_via_jspb_and_json")))break b;mn()}}if(!O("suppress_error_204_logging")){var tb=ra,Jc=tb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:tb.name,msg:tb.message.substr(0,250),line:tb.lineNumber,level:h,"client.name":Jc.name},postParams:{url:N("PAGE_NAME",
window.location.href),file:tb.fileName},method:"POST"};Jc.version&&($a["client.version"]=Jc.version);if($a.postParams){tb.stack&&($a.postParams.stack=tb.stack);for(var wk=u(Object.keys(Jc)),jg=wk.next();!jg.done;jg=wk.next()){var xk=jg.value;$a.postParams["client."+xk]=Jc[xk]}var kg=Ch();if(kg)for(var yk=u(Object.keys(kg)),lg=yk.next();!lg.done;lg=yk.next()){var zk=lg.value;$a.postParams[zk]=kg[zk]}var Ak=N("SERVER_NAME"),Bk=N("SERVER_VERSION");Ak&&Bk&&($a.postParams["server.name"]=Ak,$a.postParams["server.version"]=
Bk)}ni(N("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{Dn.add(ra.message)}catch(ro){}En++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function fo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function go(a){return 0===a.search("get")||0===a.search("is")}
;function ho(a,b){Yn.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.N={};this.playerInfo={}}
...
function io(a,b){if(Pa(b))for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c])}
...
return this})},a)}
n.getVideoEmbedCode=function(){var a=Un(this.j,"host")+("/embed/"+Un(this.j,"videoId")),b=Number(Un(this.j,"width")),c=Number(Un(this.j,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);Gb.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(Ab,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(Bb,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(Cb,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(Db,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(Eb,"&#39;")),-1!=a.indexOf("\x00")&&
